...
// $Id: calendar.js,v 1.2 2009-07-21 16:10:46 Neil Strickland Exp $
...
Calendar.setup_all = function() {
 var i,ip,ips,d,s,url;
 ...
 for (i in ips) {
  ...
  e = document.getElementById(ip.id + '_button');
  if (! e) { continue; }
  
  x = new Object;
  x.inputField = ip.id;
  x.button = ip.id + '_button';
  x.eventName = 'click';
  x.ifFormat = '%Y-%m-%d';
  x.step = 1;
...
window.loaded_scripts.calendar = 1;
