...
sangaku.poll.key = 'id';
sangaku.poll.fields = {"id":{"type":"integer","notnull":"true"},"module_id":{"type":"integer","link":"module"},"problem_sheet_id":{"type":"integer","link":"problem_sheet"},"session_id":{"type":"integer","link":"session"},"code":{"type":"text"},"title":{"type":"text"},"intro":{"type":"text"},"solution":{"type":"text"},"is_judgemental":{"type":"boolean","default":0},"is_multiple":{"type":"boolean","default":0}};
