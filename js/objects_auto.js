...
sangaku.session.fields = {"id":{"type":"integer","notnull":"true"},"problem_sheet_id":{"type":"integer","link":"problem_sheet"},"tutorial_group_id":{"type":"integer","link":"tutorial_group"},"date":{"type":"date"},"time":{"type":"time"},"duration":{"type":"integer","default":50,"notnull":true},"is_confirmed":{"type":"boolean","default":0,"notnull":true},"solutions_shown":{"type":"text"},"video_url":{"type":"text"}};
...
sangaku.tutorial_group.fields = {"id":{"type":"integer","notnull":"true"},"somas_id":{"type":"integer"},"module_id":{"type":"integer","link":"module"},"name":{"type":"text"},"is_regular":{"type":"boolean","default":1},"semester":{"type":"text"},"day_number":{"type":"integer"},"hour":{"type":"integer"},"week_parity":{"type":"text"}};
