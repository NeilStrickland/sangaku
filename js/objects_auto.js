...
sangaku.module.fields = {"id":{"type":"integer","notnull":"true"},"somas_moid":{"type":"integer"},"code":{"type":"text"},"title":{"type":"text"},"is_regular":{"type":"boolean","default":1},"semester":{"type":"text"},"blackboard_url":{"type":"text"}};
...
sangaku.session.fields = {"id":{"type":"integer","notnull":"true"},"problem_sheet_id":{"type":"integer","link":"problem_sheet"},"tutorial_group_id":{"type":"integer","link":"tutorial_group"},"date":{"type":"text"},"time":{"type":"text"},"duration":{"type":"integer","default":50,"notnull":true},"is_confirmed":{"type":"boolean","default":0,"notnull":true},"solutions_shown":{"type":"text"}};
