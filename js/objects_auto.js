...
sangaku.module.fields = {"id":{"type":"integer","notnull":"true"},"codee":{"type":"text"},"title":{"type":"text"}};
...
sangaku.problem_sheet.fields = {"id":{"type":"integer","notnull":"true"},"module_id":{"type":"integer","link":"module"},"title":{"type":"text"},"intro":{"type":"text"},"latex_source":{"type":"text"}};
...
sangaku.tutorial_group.fields = {"id":{"type":"integer","notnull":"true"},"module_id":{"type":"integer","link":"module"},"name":{"type":"text"}};
...
sangaku.question_item.fields = {"id":{"type":"integer","notnull":"true"},"problem_sheet_id":{"type":"integer","link":"problem_sheet"},"parent_id":{"type":"integer","link":"question_item"},"titled_header":{"type":"text"},"header":{"type":"text"},"full_header":{"type":"text"},"level":{"type":"integer"},"is_bottom":{"type":"boolean"},"problem":{"type":"text"},"solution":{"type":"text"}};
sangaku.session = Object.create(sangaku.object);
sangaku.session.object_type = 'session';
sangaku.session.key = 'id';
sangaku.session.fields = {"id":{"type":"integer","notnull":"true"},"problem_sheet_id":{"type":"integer","link":"problem_sheet"},"tutorial_group_id":{"type":"integer","link":"tutorial_group"},"start_time":{"type":"text"},"duration":{"type":"integer","default":50,"notnull":true}};
sangaku.user = Object.create(sangaku.object);
sangaku.user.object_type = 'user';
sangaku.user.key = 'id';
sangaku.user.fields = {"id":{"type":"integer","notnull":"true"},"username":{"type":"text"},"surname":{"type":"text"},"forename":{"type":"text"},"status":{"type":"text"}};
