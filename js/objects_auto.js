...
sangaku.module.fields = {"id":{"type":"integer","notnull":"true"},"somas_moid":{"type":"integer"},"code":{"type":"text"},"title":{"type":"text"}};
...
sangaku.session.fields = {"id":{"type":"integer","notnull":"true"},"problem_sheet_id":{"type":"integer","link":"problem_sheet"},"tutorial_group_id":{"type":"integer","link":"tutorial_group"},"start_time":{"type":"text"},"duration":{"type":"integer","default":50,"notnull":true},"is_confirmed":{"type":"boolean","default":0,"notnull":true},"solutions_shown":{"type":"text"}};
...
sangaku.tutorial_group.fields = {"id":{"type":"integer","notnull":"true"},"somas_id":{"type":"integer"},"module_id":{"type":"integer","link":"module"},"name":{"type":"text"},"day_number":{"type":"integer"},"hour":{"type":"integer"},"week_parity":{"type":"text"}};
...
sangaku.user.key = 'id';
sangaku.user.fields = {"id":{"type":"integer","notnull":"true"},"somas_student_id":{"type":"integer"},"somas_person_id":{"type":"integer"},"username":{"type":"text"},"gmail_name":{"type":"text"},"surname":{"type":"text"},"forename":{"type":"text"},"status":{"type":"text"}};
